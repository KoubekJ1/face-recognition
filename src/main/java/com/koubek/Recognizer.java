...
public class Recognizer {
    ...
    public static final Person UNRECOGNIZED = new Person("Unrecognized", false);
    ...
    public Person recognizeFace(Mat face)
    {
        ...
        return confidence[0] < 50 ? people.get(label[0]) : UNRECOGNIZED;
